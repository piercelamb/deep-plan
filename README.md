...
2. **Find from pwd** (development fallback) - Searches current directory tree
3. **Find from CLAUDE_PLUGIN_ROOT parent** (edge case) - Searches plugin directory tree

If multiple copies exist, you'll see a warning indicating which path was chosen.
